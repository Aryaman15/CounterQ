"""Candidate-safe canonical fixture corpus for deterministic CounterMap evaluation."""
...
def load_countermap_corpus() -> tuple[CounterMapCorpusFixture, ...]:
    return (
        CounterMapCorpusFixture("simulation-success-and-misconception", _simulation()),
        CounterMapCorpusFixture("coach-assisted-improvement-open-breakpoint", _coach()),
        CounterMapCorpusFixture("delivery-and-self-correction-integrity", _integrity()),
    )
